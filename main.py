...
QUOTEX_OFFSET = int(os.getenv("QUOTEX_OFFSET", 10))
TIMEZONE = timezone("Asia/Dhaka")
HOST_URL = os.getenv("HOST_URL")
PORT = int(os.environ.get("PORT", 10000))  # Render will auto-assign port
...
# Finnhub supported Forex pairs (OANDA format)
PAIRS = {
    "EUR_USD": "EUR/USD",
    "GBP_USD": "GBP/USD",
    "USD_JPY": "USD/JPY",
...
def generate_signals():
    signals = {}
    for symbol_key, display_name in PAIRS.items():
        trend = analyze_trend(symbol_key)
        if trend:
